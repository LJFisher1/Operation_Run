...
public class GiveWeaponOnDestroy : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        if (GameManager.instance.player != null && GameManager.instance.playerController.isActiveAndEnabled) GameManager.instance.playerController.ChangeWeapon(weapon);
        else return;
    }
}
