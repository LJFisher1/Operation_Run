...
public class TrapSpikeTimed : MonoBehaviour
{
    [Header("* Controls")]
    [SerializeField] bool activate;
    [SerializeField] bool position;
    [Header("* Settings")]
    [SerializeField] int activateSpeed;
    ...
    [SerializeField] AudioClip[] audioActivate;
    ...
    {
        yield return new WaitForSeconds(activateSpeed);
        audioSource.PlayOneShot(audioActivate[0], audioVolume);
        position = true;
        activate = true;
